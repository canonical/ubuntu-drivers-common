...
menuentry 'Ubuntu' --class ubuntu --class gnu-linux --class gnu --class os $menuentry_id_option 'gnulinux-simple-abc123' {
    recordfail
    load_video
...
submenu 'Advanced options for Ubuntu' $menuentry_id_option 'gnulinux-advanced-abc123' {
    menuentry 'Ubuntu, with Linux 5.15.0-97-generic' --class ubuntu --class gnu-linux --class gnu --class os $menuentry_id_option 'gnulinux-5.15.0-97-generic-advanced-abc123' {
        recordfail
        load_video
        gfxmode $linux_gfx_mode
        insmod gzio
    ...
    menuentry 'Ubuntu, with Linux 5.15.0-91-generic' --class ubuntu --class gnu-linux --class gnu --class os $menuentry_id_option 'gnulinux-5.15.0-91-generic-advanced-abc123' {
        recordfail
        load_video
        gfxmode $linux_gfx_mode
        insmod gzio
    ...
    menuentry 'Ubuntu, with Linux 5.13.0-52-generic' --class ubuntu --class gnu-linux --class gnu --class os $menuentry_id_option 'gnulinux-5.13.0-52-generic-advanced-abc123' {
        recordfail
        load_video
...
"""
    ...
    def test_parse_grub_cfg_numeric_entry_first(self):
        ...
        result = UbuntuDrivers.detect._parse_grub_cfg_for_kernel(self.simple_grub_cfg, "0")
    ...
    def test_parse_grub_cfg_numeric_entry_second(self):
        ...
        result = UbuntuDrivers.detect._parse_grub_cfg_for_kernel(self.simple_grub_cfg, "1")
    ...
    def test_parse_grub_cfg_numeric_entry_third(self):
        ...
        result = UbuntuDrivers.detect._parse_grub_cfg_for_kernel(self.simple_grub_cfg, "2")
    ...
    def test_parse_grub_cfg_numeric_entry_out_of_range(self):
        ...
        result = UbuntuDrivers.detect._parse_grub_cfg_for_kernel(self.simple_grub_cfg, "10")
...
"""
    ...
    def test_parse_grub_cfg_complex_vmlinuz_path(self):
        ...
        complex_cfg = """
menuentry 'Test' {
    linux   /boot/vmlinuz-5.15.0-97-generic-custom root=UUID=abc ro quiet
    initrd  /boot/initrd.img
}
"""
    ...
    def test_parse_grub_cfg_with_quotes_in_id(self):
        ...
        result = UbuntuDrivers.detect._parse_grub_cfg_for_kernel(cfg_single, "my-kernel-id")
        self.assertEqual(result, "5.15.0-97-generic")
        
        # Test with double quotes
        cfg_double = 'menuentry "Ubuntu" --id "my-kernel-id2" {\n    linux /vmlinuz-5.15.0-91-generic\n}'
        result = UbuntuDrivers.detect._parse_grub_cfg_for_kernel(cfg_double, "my-kernel-id2")
        self.assertEqual(result, "5.15.0-91-generic")

    def test_parse_grub_cfg_multiple_matches_for_id(self):
        """Test parsing grub config with duplicate IDs (should handle gracefully)"""
        duplicate_cfg = """
...
"""
        ...
        f = io.StringIO()
        with redirect_stdout(f):
            result = UbuntuDrivers.detect._parse_grub_cfg_for_kernel(duplicate_cfg, "duplicate-id")
    ...
    def test_get_kernel_from_grub_entry_integration(self):
        """Test full integration of _get_kernel_from_grub_entry using _parse_grub_cfg_for_kernel directly"""
        # Test that the high-level function works correctly
        # We test with content directly since we already tested _load_grub_cfg separately
        result = UbuntuDrivers.detect._parse_grub_cfg_for_kernel(self.simple_grub_cfg, "1")
        self.assertEqual(result, "6.5.0-14-generic")
...
"""
        result = UbuntuDrivers.detect._parse_grub_cfg_for_kernel(mixed_whitespace_cfg, "0")
        self.assertEqual(result, "5.15.0-97-generic")
