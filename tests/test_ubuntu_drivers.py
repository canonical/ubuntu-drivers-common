...
class DetectTest(unittest.TestCase):
    ...
    @patch('UbuntuDrivers.detect.path_get_customized_supported_gpus')
    def test_system_driver_packages_force_install_nvidia(self, mocked_pgcsg):
        ...
        try:
            ...
            # Generate /etc/customized_supported_gpus.json
            csg_file = os.path.abspath(os.path.join(chroot.path, "etc", "customized_supported_gpus.json"))
